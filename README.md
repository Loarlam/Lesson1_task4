...
От себя:
>для возможности вывода на экран периметра треугольника и прямоугольника необходимо в файле Program.cs, в 26 строке в скобках, оставить необходимое количество букв.
